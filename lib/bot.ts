...
export const bot = new Bot(Deno.env.get("BOT_TOKEN") || "7585974941:AAEPlLf93JTpesrDpAIOysQvM4Z8b8ySub8"); // export нужен, чтобы воспользоваться ботом в другом файле
